 ...
 */
final class SupportTicketsApiDocsTest extends TestCase
{
    ...
    private static function mountedRoutes(): array
    {
        ...
        $registry = new ModuleRegistry([new SupportTicketsModule()]);
    ...
    private static function documentedRoutes(): array
    {
        return array_map(
            ...
            (new SupportTicketsModule())->apiDocs(),
        );
    }
    ...
    public function testEveryEntryIsWellFormed(): void
    {
        $permissions = array_map(
            ...
            (new SupportTicketsModule())->permissions(),
        );

        foreach ((new SupportTicketsModule())->apiDocs() as $doc) {
